...
- [ ] **Curate the white-paper-cited claims.** Reference [1] (Surgeon General 1964, `claims/cmqwoxe6l07dy8o0y6xrs8xnv`) renders UNREVIEWED, "Dormant · no revisions," "unreviewed since emergence," two sources at unexplained 50/100, and **no settling-curve transitions** — for the paper's marquee smoking example. Same treatment for reference [2] (H. pylori, `claims/cmqoappnu03yxsadpa90nu942`). Both papers' and both Substack drafts' footnotes land on these URLs. Build the curves, review the claims, source the scores.
- [ ] **Reconcile the three public corpus totals.** Homepage: 1.62M. /pipelines: 1,619,729. /sources: 1,757,647. All three are live-derived but from different filters. Pick one canonical derivation (or label explicitly: "active claims" vs "all claims incl. deprecated / no-history"). One number, everywhere, or a labeled distinction.
