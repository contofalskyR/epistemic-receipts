// Enrich the epistemic arc for the "Mucinex Children's FreeFrom Multi-Symptom
// Cold, Flu and Sore Throat" combination FDA-label claim (openfda_labels_v1).
//
// Claim: cmpixt5rj85mcplo7huwlka72 — a fixed-dose OTC combination
// (ACETAMINOPHEN 325 mg, DEXTROMETHORPHAN HBr 10 mg, GUAIFENESIN 200 mg,
// PHENYLEPHRINE HCl 5 mg per 10 mL) whose label "Purposes" statement asserts
// pain reliever/fever reducer, cough suppressant, expectorant, and nasal
// decongestant activity.
//
// There is no single Phase II/III trial for a four-way OTC combination — the
...
// contested arc. That is the arc enriched here. (Sources are shared, idempotent
// upserts keyed by externalId with the companion cold-flu combination enrichment.)
//
// Arc (chronological, monotonic):
//   OPEN     -> RECORDED  1994-08-23  Final OTC nasal decongestant monograph (21 CFR 341) codifies
//                                     oral phenylephrine HCl as Category I / GRASE
...
//
// Run:     npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-mucinex-childrens-freefrom-multi-symptom.ts
// Dry-run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-mucinex-childrens-freefrom-multi-symptom.ts --dry-run
...
const CLAIM_ID = 'cmpixt5rj85mcplo7huwlka72'
...
const TRANSITIONS: Transition[] = [
  // ── OPEN -> RECORDED: OTC nasal decongestant final monograph codifies phenylephrine as GRASE (1994) ──
  {
    fromAxis: 'OPEN',
    toAxis: 'RECORDED',
    ...
    datePrecision: 'DAY',
    reason:
      'The FDA Final Monograph for OTC nasal decongestant drug products (published in the Federal Register at 59 FR 43386 on August 23, 1994, and codified within 21 CFR Part 341, "Cold, Cough, Allergy, Bronchodilator, and Antiasthmatic Drug Products for Over-the-Counter Human Use") recognized oral phenylephrine hydrochloride, together with the companion antitussive (dextromethorphan) and expectorant (guaifenesin) actives, as Category I — generally recognized as safe and effective at labeled doses. This is the first federal recording of the efficacy claims that the Mucinex Children\'s FreeFrom product later restates in its label "Purposes" statement: pain reliever/fever reducer, cough suppressant, expectorant, and nasal decongestant.',
    source: {
