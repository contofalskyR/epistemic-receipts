...
//   cmpiyma9j936oplo722n82ue3 —
//   "Freshands Premium Foamy Antibacterial Handsoap 6876 (CHLOROXYLENOL):
...
//
// Run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-chloroxylenol-antiseptic-arc.ts
...
const CLAIM_ID = 'cmpiyma9j936oplo722n82ue3'
  ...
  for (const tr of TRANSITIONS) {
    const source = await prisma.source.upsert({
      ...
      create: {
        ...
        ingestedBy: 'enrich:openfda_labels_v1-chloroxylenol-antiseptic-arc',
      },
      update: {
        name: tr.source.name,
        url: tr.source.url,
