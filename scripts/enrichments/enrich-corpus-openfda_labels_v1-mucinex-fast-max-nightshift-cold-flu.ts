// Enrichment: epistemic arc for the FDA "Maximum Strength Mucinex Fast-Max
// Cold and Flu and Mucinex NightShift Severe Cold and Flu" OTC label claim.
//
// Claim: cmpixvi5u88icplo768ui8e6g (openfda_labels_v1)
...
//   NightShift formulation — Triprolidine HCl (antihistamine).
//
...
// honest arc therefore tracks the ingredient whose labeled "Purpose" has an
// actual contested epistemic history: PHENYLEPHRINE, the oral nasal decongestant
// that the FDA has since concluded is not effective at monograph doses.
//
...
//                         purpose of the phenylephrine HCl 10 mg component.
...
// URLs are anchored on stable canonical pages (eCFR part-level, Wikipedia,
// FDA press announcement) already used by the sibling Fast-Max enrichment.
//
// Idempotent: upserts on Source.externalId and ClaimStatusHistory.id.
//
// Run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-mucinex-fast-max-nightshift-cold-flu.ts
...
const CLAIM_ID = 'cmpixvi5u88icplo768ui8e6g'
...
const TRANSITIONS: Transition[] = [
  {
    ...
    source: {
      externalId: 'src:mucinex-nightshift-otc-panel-1976',
  ...
  },
  {
    ...
    source: {
      externalId: 'src:mucinex-nightshift-cfr341-monograph',
  ...
  },
  {
    ...
    source: {
      externalId: 'src:mucinex-nightshift-fda-phenylephrine-2024',
