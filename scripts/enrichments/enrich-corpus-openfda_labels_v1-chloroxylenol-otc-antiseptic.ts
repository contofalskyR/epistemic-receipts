...
//   cmpiyk9k390piplo7rydgml66
//   "Fresh Start (CHLOROXYLENOL): Drug Facts Box OTC-Purpose Section Antiseptic"
//
...
//
// Run:     npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-chloroxylenol-otc-antiseptic.ts
// Dry-run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-chloroxylenol-otc-antiseptic.ts --dry-run
...
const CLAIM_ID = 'cmpiyk9k390piplo7rydgml66'
