// Enrichment: epistemic arc for the FDA "Maximum Strength Mucinex Sinus-Max
// Severe Congestion and Pain" OTC label claim.
//
// Claim: cmpixw1ux898iplo7p8kticnu (openfda_labels_v1)
//   Combination product: Acetaminophen 325 mg (pain reliever), Guaifenesin
//   200 mg (expectorant), Phenylephrine HCl 5 mg (nasal decongestant).
//
// All three actives are long-established OTC-monograph drugs, so there is no
...
// actual contested epistemic history: PHENYLEPHRINE, the oral nasal
// decongestant that the FDA has since concluded is not effective at monograph
// doses.
//
...
//                         companion analgesic/expectorant actives) as generally
//                         recognized as safe and effective (GRASE) — the settled
//                         regulatory + standard-of-care basis for cold/sinus
//                         combinations. Ratified by INSTITUTIONAL (FDA).
...
//                         purpose of the phenylephrine HCl 5 mg component.
...
//
// Run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-mucinex-sinus-max-severe-congestion-pain.ts
...
const CLAIM_ID = 'cmpixw1ux898iplo7p8kticnu'
...
const TRANSITIONS: Transition[] = [
  {
    ...
    datePrecision: 'YEAR',
    reason:
      'The FDA OTC Drug Review Advisory Review Panel on Cough, Cold, Allergy, Bronchodilator, and Antiasthmatic Products completed the first systematic published evaluation of this product\'s active ingredients — acetaminophen, guaifenesin, and phenylephrine — and classified each for its labeled purpose, including oral phenylephrine as a Category I (safe and effective) nasal decongestant. This panel report is the first published clinical-evidence record supporting the finished product\'s stated Purposes.',
    source: {
      externalId: 'src:mucinex-sinusmax-otc-panel-1976',
  ...
  },
  {
    ...
    datePrecision: 'MONTH',
    reason:
      'The FDA final OTC monograph for cold, cough, allergy, bronchodilator, and antiasthmatic drug products, codified at 21 CFR part 341, recognized oral phenylephrine hydrochloride as generally recognized as safe and effective (GRASE) at monograph doses, alongside the companion analgesic/antipyretic and expectorant actives. Monograph status let manufacturers market these combinations without individual New Drug Applications and made them the standard nonprescription actives for cold and sinus products, settling the regulatory and clinical consensus behind this label.',
    source: {
      externalId: 'src:mucinex-sinusmax-cfr341-monograph',
