...
// Cold and Flu" OTC label claim.
//
// Claim: cmpixtj6e85zuplo7v9ey5lus (openfda_labels_v1)
//   Combination product: Acetaminophen 650 mg (pain reliever/fever reducer),
//   Dextromethorphan HBr 20 mg (cough suppressant), Guaifenesin 400 mg
//   (expectorant), Phenylephrine HCl 10 mg (nasal decongestant).
//
// These four actives are all long-established OTC-monograph drugs, so there is
// no single Phase II/III registration trial for the finished combination. The
...
// the FDA has since concluded is not effective at monograph doses.
//
...
// final removal), and the product's three other actives remain GRASE, so the
...
// Live web verification was unavailable in this session; URLs are anchored on
// stable canonical pages (eCFR part-level, Wikipedia, FDA press announcement).
//
// Idempotent: upserts on Source.externalId and ClaimStatusHistory.id.
//
// Run: npx tsx scripts/enrichments/enrich-corpus-openfda_labels_v1-mucinex-fast-max-cold-and-flu.ts
...
const CLAIM_ID = 'cmpixtj6e85zuplo7v9ey5lus'
