...
const TRAJECTORIES: Trajectory[] = [
  ...
  // ── 44. AHA first dietary fat recommendation — 1961 ─────────────────────────
  {
    externalId: 'trajectory:aha-first-dietary-fat-recommendation-1961',
    text: 'In January 1961 the American Heart Association issued the first recommendation by a major national medical body that people at risk of heart disease reduce dietary saturated fat and substitute polyunsaturated vegetable oils, in the Circulation report \'Dietary Fat and Its Relation to Heart Attacks and Strokes.\'',
    claimType: 'HYBRID',
    claimEmergedAt: '1961-01-01',
    claimEmergedPrecision: 'MONTH',
    currentAxis: 'SETTLED',
    transitions: [
      {
        ...
        datePrecision: 'MONTH',
        reason: 'The AHA\'s Central Committee for Medical and Community Program (Page, Allen, Chamberlain, Keys, Stamler, Stare) published \'Dietary Fat and Its Relation to Heart Attacks and Strokes\' in Circulation, the first statement by a national medical organization advising reduction of saturated fat and substitution of polyunsaturated vegetable oils for people at elevated coronary risk. It converted the diet-heart hypothesis from a research position into an institutional recommendation, 16 years before the McGovern Report generalized it to the whole population.',
        source: {
          externalId: 'src:aha-dietary-fat-circulation-1961',
          name: 'Central Committee for Medical and Community Program of the American Heart Association (Page IH, Allen EV, Chamberlain FL, Keys A, Stamler J, Stare FJ). Dietary Fat and Its Relation to Heart Attacks and Strokes. Circulation. 1961;23(1):133–136.',
          url: 'https://www.ahajournals.org/doi/10.1161/01.CIR.23.1.133',
      ...
      },
      {
        ...
        toAxis: 'SETTLED',
        community: 'INSTITUTIONAL',
        occurredAt: '2017-06-15',
        datePrecision: 'DAY',
        reason: 'After decades in which the saturated-fat recommendation was challenged in the expert literature, the AHA issued a Presidential Advisory (Sacks et al., Circulation, June 15 2017) that systematically reviewed the randomized trial and cohort evidence and reaffirmed that replacing saturated fat with polyunsaturated vegetable oil lowers cardiovascular disease. The advisory represents the institution consolidating and defending its position rather than retreating, holding the 1961 recommendation as settled AHA policy.',
        source: {
          externalId: 'src:aha-dietary-fats-presidential-advisory-2017',
          name: 'Sacks FM, Lichtenstein AH, Wu JHY, et al. Dietary Fats and Cardiovascular Disease: A Presidential Advisory From the American Heart Association. Circulation. 2017;136(3):e1–e23.',
  ...
  // ── 45. Trans fat lipoprotein harm — Mensink & Katan — 1990 ─────────────────
  {
    externalId: 'trajectory:trans-fat-lipoprotein-harm-mensink-katan-1990',
    text: 'On August 16, 1990 Ronald Mensink and Martijn Katan reported in the New England Journal of Medicine the first rigorous controlled feeding trial showing that dietary trans fatty acids raise LDL cholesterol and lower HDL cholesterol, making the partially hydrogenated vegetable oils in margarine at least as harmful to blood lipids as the saturated fats they had replaced.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '1990-08-16',
    claimEmergedPrecision: 'DAY',
    currentAxis: 'SETTLED',
    transitions: [
      {
        ...
        toAxis: 'RECORDED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '1990-08-16',
        datePrecision: 'DAY',
        reason: 'Mensink and Katan fed 59 healthy volunteers three isocaloric diets (oleic acid, trans fatty acids, or saturated fatty acids providing 10% of energy) in random order for three weeks each, and found trans fatty acids both raised LDL and uniquely lowered HDL, giving them a worse effect on the total-to-HDL cholesterol ratio than saturated fat. It was the first controlled human evidence that the partially hydrogenated oils promoted as the healthy alternative to butter were themselves atherogenic, opening the trans-fat question in the expert literature.',
        source: {
          externalId: 'src:mensink-katan-transfat-nejm-1990',
          name: 'Mensink RP, Katan MB. Effect of Dietary trans Fatty Acids on High-Density and Low-Density Lipoprotein Cholesterol Levels in Healthy Subjects. New England Journal of Medicine. 1990;323(7):439–445.',
          url: 'https://www.nejm.org/doi/full/10.1056/NEJM199008163230703',
          publishedAt: '1990-08-16',
          methodologyType: 'primary',
        },
      },
      {
        ...
        toAxis: 'SETTLED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '1993-03-06',
        datePrecision: 'DAY',
        reason: 'Willett, Stampfer, and colleagues published prospective data from the Nurses\' Health Study (over 85,000 women, 8-year follow-up) in the Lancet showing that higher trans fatty acid intake was associated with significantly increased risk of coronary heart disease. Combined with the Mensink–Katan mechanism, the large cohort link moved trans-fat harm from a lipid-biomarker finding to a settled clinical conclusion in the nutrition literature.',
        source: {
          externalId: 'src:willett-transfat-chd-lancet-1993',
          name: 'Willett WC, Stampfer MJ, Manson JE, et al. Intake of trans fatty acids and risk of coronary heart disease among women. Lancet. 1993;341(8845):581–585.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/8094827/',
          publishedAt: '1993-03-06',
          methodologyType: 'primary',
        },
      },
      {
        ...
        toAxis: 'SETTLED',
        community: 'INSTITUTIONAL',
        occurredAt: '2003-07-11',
        datePrecision: 'DAY',
        reason: 'The FDA issued a final rule (68 FR 41434, effective January 1, 2006) requiring trans fat to be declared on the Nutrition Facts label on a line immediately below saturated fat, citing the human evidence that trans fat raises LDL cholesterol. Regulatory adoption of the labeling requirement marked institutional acceptance of trans-fat harm, distinct from and preceding the 2013–2015 revocation of GRAS status for partially hydrogenated oils.',
        source: {
          externalId: 'src:fda-transfat-labeling-final-rule-2003',
          name: 'FDA. Food Labeling: Trans Fatty Acids in Nutrition Labeling, Nutrient Content Claims, and Health Claims. Final Rule. 68 FR 41434. July 11, 2003.',
          url: 'https://www.federalregister.gov/documents/2003/07/11/03-17525/food-labeling-trans-fatty-acids-in-nutrition-labeling-nutrient-content-claims-and-health-claims',
  ...
  // ── 46. Cholesterol lowering reduces CHD — LRC-CPPT — 1984 ──────────────────
  {
    externalId: 'trajectory:cholesterol-lowering-reduces-chd-lrc-cppt-1984',
    text: 'On January 20, 1984 the Lipid Research Clinics Coronary Primary Prevention Trial reported in JAMA that lowering blood cholesterol with cholestyramine reduced coronary heart disease events in high-risk men, and later that year an NIH Consensus Conference declared that lowering elevated blood cholesterol reduces heart-disease risk, settling the lipid hypothesis and launching the National Cholesterol Education Program.',
    claimType: 'HYBRID',
    ...
    transitions: [
      {
        ...
        datePrecision: 'DAY',
        reason: 'The LRC-CPPT, a randomized double-blind trial of 3,806 asymptomatic men with hypercholesterolemia, reported in JAMA that the cholestyramine group had a 19% reduction in coronary heart disease death or nonfatal myocardial infarction versus placebo, yielding the influential \'two-for-one\' estimate that each 1% reduction in cholesterol lowered coronary risk by about 2%. It was framed as the first trial to demonstrate that pharmacologically lowering cholesterol reduces coronary events.',
        source: {
          externalId: 'src:lrc-cppt-results-i-jama-1984',
          ...
          url: 'https://jamanetwork.com/journals/jama/fullarticle/391065',
      ...
      },
      {
        ...
        toAxis: 'SETTLED',
        community: 'INSTITUTIONAL',
        occurredAt: '1984-12-12',
        datePrecision: 'DAY',
        reason: 'At the NIH Consensus Development Conference on Lowering Blood Cholesterol to Prevent Heart Disease (December 10–12, 1984), an expert panel concluded that lowering elevated blood cholesterol, particularly LDL cholesterol, will reduce the risk of heart attacks, and for the first time the NIH went on record advocating screening and aggressive treatment. The conference directly launched the National Cholesterol Education Program in 1985, converting the LRC-CPPT result into settled national health policy.',
        source: {
          externalId: 'src:nih-consensus-cholesterol-1984',
          name: 'NIH Consensus Development Conference. Lowering Blood Cholesterol to Prevent Heart Disease. Consensus Statement (Dec 10–12, 1984). JAMA. 1985;253(14):2080–2086.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/4058807/',
  ...
  // ── 47. Linoleic acid substitution reduces CHD — contested 2013 ──────────────
  {
    externalId: 'trajectory:linoleic-acid-substitution-reduces-chd-1969',
    text: 'In July 1969 Seymour Dayton and colleagues reported in Circulation that replacing saturated fat with polyunsaturated vegetable oil (linoleic acid) reduced atherosclerotic complications in the Los Angeles Veterans Administration trial, establishing the vegetable-oil substitution hypothesis that was later contested when the buried mortality data of similar trials were recovered.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '1969-07-01',
    claimEmergedPrecision: 'MONTH',
    currentAxis: 'CONTESTED',
    transitions: [
      {
        ...
        occurredAt: '1969-07-01',
        datePrecision: 'MONTH',
        reason: 'Dayton et al. randomized 846 institutionalized men to a conventional diet or one substituting polyunsaturated vegetable oil for saturated fat and reported fewer atherosclerotic cardiovascular events in the intervention group in Circulation. Together with contemporaneous trials it was read as confirming that swapping saturated fat for linoleic-acid-rich vegetable oils prevents heart disease, underpinning the promotion of polyunsaturated margarines and cooking oils.',
        source: {
          externalId: 'src:dayton-la-veterans-circulation-1969',
          name: 'Dayton S, Pearce ML, Hashimoto S, Dixon WJ, Tomiyasu U. A Controlled Clinical Trial of a Diet High in Unsaturated Fat in Preventing Complications of Atherosclerosis. Circulation. 1969;40(1 Suppl 2):II-1–II-63.',
          url: 'https://www.ahajournals.org/doi/10.1161/01.CIR.40.1S2.II-1',
          publishedAt: '1969-07-01',
          methodologyType: 'primary',
        },
      },
      {
        ...
        toAxis: 'CONTESTED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2013-02-04',
        datePrecision: 'DAY',
        reason: 'Ramsden and colleagues recovered the lost original data of the Sydney Diet Heart Study (1966–73) and reported in the BMJ that men who replaced saturated fat with omega-6 linoleic acid from safflower oil had higher all-cause, cardiovascular, and coronary mortality than controls. The recovered evidence directly challenged the substitution hypothesis and reopened the question of whether polyunsaturated vegetable oils are protective.',
        source: {
          externalId: 'src:ramsden-sydney-diet-heart-bmj-2013',
          name: 'Ramsden CE, Zamora D, Leelarthaepin B, et al. Use of dietary linoleic acid for secondary prevention of coronary heart disease and death: evaluation of recovered data from the Sydney Diet Heart Study and updated meta-analysis. BMJ. 2013;346:e8707.',
      ...
      },
      {
        ...
        datePrecision: 'DAY',
        reason: 'Ramsden and colleagues recovered and analyzed the full data of the Minnesota Coronary Experiment (1968–73), the largest such trial (n=9,570), and reported in the BMJ that replacing saturated fat with linoleic-acid-rich vegetable oil lowered serum cholesterol but produced no mortality benefit and possibly higher mortality, with a 22% higher risk of death per 30 mg/dL fall in cholesterol. The 40-year-buried data intensified the contest over the vegetable-oil substitution hypothesis, though mainstream bodies continued to endorse it.',
        source: {
          externalId: 'src:ramsden-minnesota-coronary-bmj-2016',
          name: 'Ramsden CE, Zamora D, Majchrzak-Hong S, et al. Re-evaluation of the traditional diet-heart hypothesis: analysis of recovered data from Minnesota Coronary Experiment (1968-73). BMJ. 2016;353:i1246.',
  ...
  // ── VITAL — vitamin D fracture prevention null — 2022 ───────────────────────
  {
    externalId: 'trajectory:vital-vitamin-d-fracture-prevention-reversal-2022',
    text: 'The belief that routine vitamin D supplementation prevents fractures in generally healthy adults — the skeletal benefit that anchored the Institute of Medicine\'s 2010 vitamin D reference intakes — was contested by the VITAL bone-health analysis published July 28, 2022, which found that vitamin D3 2000 IU/day did not reduce total, hip, or nonvertebral fractures in adults not selected for vitamin D deficiency or low bone mass.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '2010-11-30',
    claimEmergedPrecision: 'DAY',
    currentAxis: 'CONTESTED',
    transitions: [
      {
        ...
        occurredAt: '2010-11-30',
        datePrecision: 'DAY',
        reason: 'The Institute of Medicine\'s Dietary Reference Intakes for Calcium and Vitamin D (released November 30, 2010) set the vitamin D RDA explicitly on the basis of skeletal health, concluding that adequate vitamin D intake supports bone strength and reduces fracture risk even as it rejected extra-skeletal claims. This institutionally settled the proposition that vitamin D\'s core, evidence-supported benefit was bone/fracture protection, underpinning decades of routine supplementation to prevent fractures.',
        source: {
          externalId: 'src:iom-dri-calcium-vitamin-d-2010',
          name: 'Institute of Medicine (Committee to Review Dietary Reference Intakes for Vitamin D and Calcium). Dietary Reference Intakes for Calcium and Vitamin D. Washington, DC: National Academies Press; November 30, 2010.',
          url: 'https://www.ncbi.nlm.nih.gov/books/NBK56070/',
      ...
      },
      {
        ...
        toAxis: 'CONTESTED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2022-07-28',
        datePrecision: 'DAY',
        reason: 'LeBoff et al. published the VITAL ancillary fracture analysis in the NEJM (July 28, 2022): among 25,871 U.S. adults randomized to vitamin D3 2000 IU/day or placebo for a median 5.3 years, supplementation did not reduce total fractures (HR 0.98), nonvertebral fractures, or hip fractures, with no benefit even in participants with low baseline vitamin D or low bone mineral density. As the largest primary-prevention fracture RCT, it contested the settled skeletal-benefit rationale for routine supplementation in generally healthy, replete adults.',
        source: {
          externalId: 'src:vital-vitamin-d-fractures-leboff-nejm-2022',
          name: 'LeBoff MS, Chou SH, Ratliff KA, et al. Supplemental Vitamin D and Incident Fractures in Midlife and Older Adults. N Engl J Med. 2022;387(4):299–309.',
  ...
  // ── D2d — vitamin D diabetes prevention null — 2019 ─────────────────────────
  {
    externalId: 'trajectory:d2d-vitamin-d-diabetes-prevention-null-2019',
    text: 'The hypothesis that vitamin D supplementation prevents progression from prediabetes to type 2 diabetes — generated by observational and meta-analytic links between low vitamin D status and diabetes risk — was contested by the D2d randomized trial published August 8, 2019, which found that vitamin D3 4000 IU/day did not significantly reduce the risk of incident diabetes in adults with prediabetes.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '2007-06-01',
    claimEmergedPrecision: 'MONTH',
    currentAxis: 'CONTESTED',
    transitions: [
      {
        ...
        datePrecision: 'MONTH',
        reason: 'Pittas et al. published a systematic review and meta-analysis in the Journal of Clinical Endocrinology & Metabolism (June 2007) reporting that higher vitamin D and calcium status was associated with lower risk of type 2 diabetes, formalizing the observational hypothesis that vitamin D supplementation might prevent diabetes. This placed the vitamin D–diabetes-prevention hypothesis on the scientific record and motivated a dedicated prevention trial.',
        source: {
          externalId: 'src:pittas-vitamin-d-diabetes-review-jcem-2007',
          name: 'Pittas AG, Lau J, Hu FB, Dawson-Hughes B. The role of vitamin D and calcium in type 2 diabetes. A systematic review and meta-analysis. J Clin Endocrinol Metab. 2007;92(6):2017–2029.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/17389701/',
      ...
      },
      {
        ...
        toAxis: 'CONTESTED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2019-08-08',
        datePrecision: 'DAY',
        reason: 'Pittas et al. published the D2d trial in the NEJM (August 8, 2019): 2,423 adults with prediabetes were randomized to vitamin D3 4000 IU/day or placebo and followed a median 2.5 years. Vitamin D did not significantly lower the incidence of diabetes (HR 0.88; 95% CI 0.75–1.04), directly contradicting the observational prevention hypothesis and placing it into active contestation despite favorable epidemiologic priors.',
        source: {
          externalId: 'src:d2d-vitamin-d-diabetes-nejm-2019',
          name: 'Pittas AG, Dawson-Hughes B, Sheehan P, et al. (D2d Research Group). Vitamin D Supplementation and Prevention of Type 2 Diabetes. N Engl J Med. 2019;381(6):520–530.',
  ...
  // ── USPSTF — vitamin supplements CVD/cancer recommendation — 2022 ────────────
  {
    externalId: 'trajectory:uspstf-vitamin-supplements-cvd-cancer-recommendation-2022',
    text: 'The U.S. Preventive Services Task Force concluded on June 21, 2022 (JAMA) that it recommends against beta-carotene and vitamin E supplements to prevent cardiovascular disease or cancer, and that evidence is insufficient to recommend multivitamins or other single/paired-nutrient supplements for that purpose — reaffirming and consolidating its 2014 position as the settled institutional stance against supplements for chronic-disease prevention in healthy adults.',
    claimType: 'INSTITUTIONAL',
    claimEmergedAt: '2014-04-15',
    claimEmergedPrecision: 'DAY',
    currentAxis: 'SETTLED',
    transitions: [
      {
        ...
        toAxis: 'RECORDED',
        community: 'INSTITUTIONAL',
        occurredAt: '2014-04-15',
        datePrecision: 'DAY',
        reason: 'The USPSTF issued its first recommendation statement on vitamin/mineral/multivitamin supplements for primary prevention of cardiovascular disease and cancer (Ann Intern Med, April 15, 2014), recommending against beta-carotene and vitamin E and finding evidence insufficient for multivitamins and other nutrients. This established the Task Force\'s formal institutional position that supplement use for chronic-disease prevention in healthy adults was not supported.',
        source: {
          externalId: 'src:uspstf-vitamin-supplements-2014-moyer',
          name: 'Moyer VA; U.S. Preventive Services Task Force. Vitamin, mineral, and multivitamin supplements for the primary prevention of cardiovascular disease and cancer: U.S. Preventive Services Task Force recommendation statement. Ann Intern Med. 2014;160(8):558–564.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/24566474/',
      ...
      },
      {
        ...
        datePrecision: 'DAY',
        reason: 'The USPSTF published an updated recommendation statement in JAMA (June 21, 2022) that, after incorporating 52 new trials since 2014, reached the same conclusions: recommend against beta-carotene (moderate certainty harms outweigh benefits) and vitamin E (no net benefit) for CVD/cancer prevention, with insufficient evidence for multivitamins and other supplements. The reaffirmation across an expanded evidence base consolidated the position into a stable, settled institutional standard for U.S. preventive practice.',
        source: {
          externalId: 'src:uspstf-vitamin-supplements-2022-mangione',
          name: 'Mangione CM, Barry MJ, Nicholson WK, et al.; US Preventive Services Task Force. Vitamin, Mineral, and Multivitamin Supplementation to Prevent Cardiovascular Disease and Cancer: US Preventive Services Task Force Recommendation Statement. JAMA. 2022;327(23):2326–2333.',
  ...
  // ── CSPPT — folic acid stroke prevention — 2015 ──────────────────────────────
  {
    externalId: 'trajectory:csppt-folic-acid-stroke-prevention-2015',
    text: 'The hypothesis that folic acid supplementation prevents first stroke — long uncertain because most trials were conducted in folate-fortified populations — was established for an unfortified population by the China Stroke Primary Prevention Trial (CSPPT), published April 7, 2015 in JAMA, which found that adding folic acid to the antihypertensive enalapril significantly reduced the risk of first stroke in Chinese adults with hypertension.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '2007-06-02',
    claimEmergedPrecision: 'DAY',
    currentAxis: 'SETTLED',
    transitions: [
      {
        ...
        toAxis: 'RECORDED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2007-06-02',
        datePrecision: 'DAY',
        reason: 'Wang et al. published a meta-analysis in The Lancet (June 2, 2007) finding that folic acid supplementation could reduce the risk of stroke, with the greatest benefit in populations without grain folic-acid fortification and among those achieving larger reductions in homocysteine. This recorded the specific, testable hypothesis that folic acid would prevent stroke in unfortified populations, isolating the conditions under which a benefit should appear.',
        source: {
          externalId: 'src:wang-folic-acid-stroke-meta-lancet-2007',
          name: 'Wang X, Qin X, Demirtas H, et al. Efficacy of folic acid supplementation in stroke prevention: a meta-analysis. Lancet. 2007;369(9576):1876–1882.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/17544768/',
          publishedAt: '2007-06-02',
          methodologyType: 'primary',
        },
      },
      {
        ...
        toAxis: 'SETTLED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2015-04-07',
        datePrecision: 'DAY',
        reason: 'Huo et al. published the CSPPT in JAMA (April 7, 2015): 20,702 hypertensive adults in China (a country without folic-acid fortification and with low baseline folate) were randomized to enalapril plus folic acid or enalapril alone. The folic acid group had a significantly lower risk of first stroke (2.7% vs 3.4%; HR 0.79) over a median 4.5 years. As a large, rigorously powered RCT in the predicted-benefit population, it settled the folic-acid stroke-prevention claim for unfortified, folate-deficient hypertensive populations.',
        source: {
          externalId: 'src:csppt-folic-acid-stroke-huo-jama-2015',
          name: 'Huo Y, Li J, Qin X, et al. (CSPPT Investigators). Efficacy of folic acid therapy in primary prevention of stroke among adults with hypertension in China: the CSPPT randomized clinical trial. JAMA. 2015;313(13):1325–1335.',
  ...
  // ── COSMOS-Web — multivitamin cognition benefit — 2023 ───────────────────────
  {
    externalId: 'trajectory:cosmos-multivitamin-cognition-benefit-2023',
    text: 'The claim that daily multivitamin supplementation improves cognition in older adults — largely abandoned after the null Physicians\' Health Study II cognitive trial in 2013 — was revived and contested by the COSMOS-Web randomized trial published in 2023 in the American Journal of Clinical Nutrition, which found that a daily multivitamin improved memory (immediate recall) relative to placebo, a finding echoing the earlier COSMOS-Mind result.',
    claimType: 'EMPIRICAL',
    claimEmergedAt: '2013-12-17',
    claimEmergedPrecision: 'DAY',
    currentAxis: 'CONTESTED',
    transitions: [
      {
        ...
        toAxis: 'CONTESTED',
        community: 'EXPERT_LITERATURE',
        occurredAt: '2013-12-17',
        datePrecision: 'DAY',
        reason: 'Grodstein et al. reported the Physicians\' Health Study II cognitive trial in Annals of Internal Medicine (December 17, 2013): long-term daily multivitamin use in 5,947 older men produced no benefit on cognitive function or verbal memory over roughly 12 years. Together with contemporaneous editorials, this null result cast the multivitamin-improves-cognition claim into strong doubt and drove a near-consensus that multivitamins do not preserve cognition.',
        source: {
          externalId: 'src:grodstein-multivitamin-cognition-phsii-2013',
          name: 'Grodstein F, O\'Brien J, Kang JH, et al. Long-term multivitamin supplementation and cognitive function in men: a randomized trial. Ann Intern Med. 2013;159(12):806–814.',
          url: 'https://pubmed.ncbi.nlm.nih.gov/24490265/',
      ...
      },
      {
        ...
        datePrecision: 'DAY',
        reason: 'Yeung et al. published COSMOS-Web in the American Journal of Clinical Nutrition (online May 24, 2023; 118(1):273–282): 3,562 older adults randomized to a daily multivitamin (Centrum Silver) or placebo showed significantly improved episodic memory (immediate recall on the ModRey test) over three years. Coming after the concordant COSMOS-Mind result (2022), this reopened and re-contested the previously abandoned claim, generating active debate over whether multivitamins meaningfully support cognitive aging.',
        source: {
          externalId: 'src:cosmos-web-multivitamin-memory-ajcn-2023',
          name: 'Yeung LK, Alschuler DM, Wall M, et al. Multivitamin Supplementation Improves Memory in Older Adults: A Randomized Clinical Trial. Am J Clin Nutr. 2023;118(1):273–282.',
