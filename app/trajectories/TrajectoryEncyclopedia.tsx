...
const LENS_COPY: Record<Lens, { label: string; blurb: string }> = {
  ...
  machine: {
    ...
    blurb:
      "The most notable curves generated by the data pipelines — ranked by reversals, transition count, and time span. Not hand-curated: every card opens in the full curve explorer, with a link to the underlying receipt and its sources. Same-day certification pairs are excluded.",
  },
};
