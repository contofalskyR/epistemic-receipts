...
function StatusBadge({ entry }: { entry: HistEntry }) {
  ...
  if (entry.status === "revised") {
    return (
      <span className="text-[10px] px-1.5 py-0.5 rounded bg-sky-950/60 text-sky-300 font-mono border border-sky-900/60">REVISED</span>
    );
  }
