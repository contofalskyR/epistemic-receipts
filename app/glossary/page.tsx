...
const SECTIONS: GlossarySection[] = [
  {
    ...
    entries: [
      ...
      { term: "Evidence score", def: "A 0–100 provenance weight on each source-claim edge — not a truth probability. Pipelines assign a starting weight at ingestion (50 is the neutral default for evidence that has not been editorially weighted; some pipelines assign conventional defaults for procedural records). Scores change only through recorded revisions, and every change — prior value, new value, reason, timestamp — is preserved in the edge's revision log. A dash means no score has been recorded." },
