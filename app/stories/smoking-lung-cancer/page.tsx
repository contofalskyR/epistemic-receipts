...
const SLUG = "smoking-lung-cancer";
...
export default async function SmokingLungCancerStoryPage() {
  ...
  const jsonLd = {
    ...
    "@type": "Article",
    headline: "Smoke and Evidence: The Fourteen-Year Road to Consensus",
    url: `${SITE_URL}/stories/smoking-lung-cancer`,
    ...
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
      <header className="space-y-3">
        ...
        <p className="text-gray-400 text-base max-w-2xl leading-relaxed">
          In September 1950, Doll and Hill linked cigarettes to lung cancer. The scientific
          consensus took fourteen more years to settle. The legal ratification took
          forty-eight.
        </p>
      </header>
      ...
      <section className="space-y-4 text-gray-300 text-[15px] leading-relaxed max-w-2xl">
        <p>
          On September 30, 1950, Richard Doll and Austin Bradford Hill published a
          case-control study in the <em>British Medical Journal</em> establishing a
          statistical association between cigarette smoking and lung cancer. The study
          compared 709 lung cancer patients against 709 matched controls; smokers were
          heavily over-represented in the cancer group.
        </p>
        <p>
          The claim entered contested status immediately. The tobacco industry funded
          counter-research and disputed the causal interpretation, arguing the association
          was confounded. The scientific debate ran for over a decade as cohort studies
          accumulated.
        </p>
        <p>
          On January 11, 1964, the U.S. Surgeon General&apos;s Advisory Committee on Smoking
          and Health released its report, reviewing over 7,000 studies. It concluded that
          cigarette smoking was causally related to lung cancer in men — settling the
          scientific consensus. The report is the marker source for the first SETTLED
          transition in this trajectory.
        </p>
        <p>
          The arc acquired a third marker on November 23, 1998, when the Tobacco Master
          Settlement Agreement bound the four major tobacco manufacturers to fund health
          research and pay restitution to state governments — legal ratification of the
          causal link the industry had disputed for half a century. The trajectory records
          this as a second SETTLED transition, confirming settlement across both scientific
